...
if __name__ == '__main__':
    file_path = '../singlesource/SPE+/sort_final_auc.csv'  # CSV文件路径
    ...
    for file1, file2 in zip(list1, list2):
        for item in file_columns:
            ...
            if file2 == file_name and len(item[1])>9:
            # if file2 == file_name and file1 == file_name1 and len(item[2]) > 8:
                ...
                print(acc1)
                list3.append(acc1)
            elif file2 == file_name and len(item[1]) <= 9:
