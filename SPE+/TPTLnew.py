...
if __name__ == '__main__':
    ...
    with open('feature_auc.txt', 'r') as file:
        lines = file.readlines()
        for line in lines:
    ...
    for file1, file2 in zip(list1, list2):
        for item in file_columns:
            ...
            if file1 == file_name and file2 == file_name1 and len(item[2]) > 8:
            ...
            elif file2 == file_name and file1 == file_name1 and len(item[2]) <= 8:
                print(1)
                file_path1 = f'../bugdata3/{file1}'
                file_path2 = f'../bugdata3/{file2}'
                df1 = pd.read_csv(file_path1)
