...
if __name__ == '__main__':
    tarin_data = pd.read_csv('TCAALL/ant-1.5_merged.csv')
    # diff-distribution training data
    A_tarin_data = pd.read_csv('TCAALL/ant-1.5_merged.csv')
    # test data
    test_data = pd.read_csv('bugdata3/ant-1.5.csv')
    ...
    # 假设 predict 是您的预测结果，label 是正确的标签
