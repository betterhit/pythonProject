...
if __name__ == '__main__':
    file_path = '../SPE+/sort_final_auc.csv'  # CSV文件路径
    ...
    # with open('claml12.txt', 'r') as file:
    #     lines = file.readlines()
    #     for line in lines:
    ...
    #         file_columns.append([file_name,file_name1,columns])
    # print(file_columns)
    ...
    for file1, file2 in zip(list1, list2):
        for item in file_columns:
            # file_name = item[0]
            # file_name1 = item [1]
            # columns_to_select = item[2]
            file_name = item[0]
            columns_to_select = item[1][0:10]

            if file2 == file_name and len(item[1])>8:
            # if file2 == file_name and file1 == file_name1 and len(item[2]) > 18:
            ...
            # elif file2 == file_name and file1 == file_name1 and len(item[2]) <= 18:
                file_path1 = f'../../bugdata3/{file1}'
                file_path2 = f'../../bugdata3/{file2}'
                df1 = pd.read_csv(file_path1)
                df2 = pd.read_csv(file_path2)
